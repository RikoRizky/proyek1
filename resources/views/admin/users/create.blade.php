<x-app-layout>
    <x-slot name="header">
        <div>
            <p class="text-xs font-bold uppercase tracking-[0.2em] text-violet-600">Administrator</p>
            <h1 class="mt-1 text-2xl font-bold tracking-tight text-slate-900">Tambah Akun Administrator</h1>
            <p class="mt-1 text-sm text-slate-600">Buat akun dengan akses penuh ke seluruh sistem.</p>
        </div>
    </x-slot>
    ...
    <div class="ui-card max-w-xl mx-auto p-6 sm:p-8">
        <form method="post" action="{{ route('admin.users.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required class="ui-input mt-2" placeholder="Contoh: Budi Santoso">
